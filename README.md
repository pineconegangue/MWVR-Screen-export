...
4. Open the .zip file using whatever extraction program you have (I still use winrar lol...)
   
<img width="732" height="441" alt="image" src="https://github.com/user-attachments/assets/323d269e-9648-489c-94b7-0b5b32aa518a" />
   
5. Open the plugins folder, it should look something like this
...
7. Import the plugins folder in UEVR
...
3. You will need to specify the screen size for the zoom camera capture. This will take a fair bit of trial an error, the format is X and Y coordinate of where the capture begins, and then X and Y size of the capture. To do this, you need to add "screen Xstart Ystart Xend Yend" to the target name
